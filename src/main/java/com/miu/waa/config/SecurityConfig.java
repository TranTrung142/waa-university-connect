...
public class SecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http.authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/api/v1/events/**").hasAnyRole(UserRole.ADMIN.name(), UserRole.STUDENT.name())
//                        .requestMatchers("/api/v1/events/live-message/**").hasAnyRole(UserRole.ADMIN.name(), UserRole.STUDENT.name())
                        .requestMatchers("/api/v1/live-message/**").permitAll()
